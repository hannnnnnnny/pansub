...
8. Click **Open settings** in the popup to adjust subtitle mode, position, size, opacity, cache, and the floating quick button.
...
8. 点击 popup 里的 **Open settings**，可以调整字幕模式、位置、大小、透明度、缓存和悬浮快捷按钮。
