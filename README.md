...
8. If you update the code later, go back to `chrome://extensions`, click the reload button on the PanSub card, then refresh the Panopto page.
...
8. 如果之后更新了代码，需要回到 `chrome://extensions`，点击 PanSub 卡片上的刷新按钮，然后刷新 Panopto 页面。
