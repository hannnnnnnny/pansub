...
点击 PanSub 图标，确认 **显示字幕** 已开启。新字幕出现时会先显示英文，翻译完成后补上中文。很 easy。
...
Click the PanSub icon and make sure **Show subtitles** is enabled. When a new caption appears, PanSub shows the English line first, then fills in the Chinese translation. Very easy.
