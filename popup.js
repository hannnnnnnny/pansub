...
const I18N = {
  ...
  'zh-CN': {
    ...
    audioDisclosureBody: 'PanSub 只捕获你主动启动的标签页音频。Chrome 在本设备完成英语语音识别，PanSub 不保存音频或完整转录。如果 Chrome 本地 Translator 不可用，只有在你另行允许后，识别出的文字才会发送到 Google Translate。仅可用于你获准访问的课程内容和个人学习，请勿导出或分享课程音频、字幕或译文。',
