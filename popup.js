...
const I18N = {
  en: {
    ...
    audioDisclosureBody: 'PanSub captures only this tab. Chrome recognizes English locally. Audio and transcripts are not saved.',
  ...
  'zh-CN': {
    ...
    audioDisclosureBody: 'PanSub 只捕获当前标签页。Chrome 在本地识别英语，音频和完整转录不会保存。',
